...
class Country
  ...
  CANADA = Country.new('Canada', ['VQA Beamsville Bench', 'VQA Niagara', 'VQA Niagara Peninsula', 'VQA Niagara On The Lake', 
  ...
  ITALY = Country.new('Italy', ['Barolo', 'Barbaresco', 'Brunello di Montalcino', 'Rosso di Montalcino', 'Calabria', 'Docg Tuscany', 'Tuscany', 'Piedmont',
