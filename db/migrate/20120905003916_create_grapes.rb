class CreateGrapes < ActiveRecord::Migration
  def up
    ...
    Grape.create :name =>  'Nerell Cappuccio'
    Grape.create :name =>  'Nerell Mascalese'
    ...
    Grape.create :name =>  'Pinot Meunier'
    ...
    Grape.create :name =>  'Grasevina'
    Grape.create :name =>  'Gruner Veltliner'
    Grape.create :name =>  'Inzolia'
    Grape.create :name =>  'Melon De Bourgogne'
    Grape.create :name =>  'Malvasia'
    Grape.create :name =>  'Moschofilero'
